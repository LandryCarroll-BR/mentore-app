import { FormBuilderDashboard } from '@/features/forms/components/dashboards/form-builder.dashboard';
...
export default function OnboardingMentorPage() {
  return (
    <FormBuilderDashboard formTitle={'Mentor Sign Up Form'} formSteps={steps} />
  );
}
